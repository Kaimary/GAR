...
from config import DIR_PATH, SEMSIMILARITY_TRIPLE_DATA_GZ_FILE, SENTENCE_EMBEDDER_MODEL_DIR, \
    RETRIVIAL_MODEL_LEARNING_RATE
...
sts_dataset_path = DIR_PATH + SEMSIMILARITY_TRIPLE_DATA_GZ_FILE.format(sys.argv[3])
