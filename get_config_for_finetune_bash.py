...
print(
    f"{config_vars['SEMSIMILARITY_TRIPLE_DATA_FINETUNE_GZ_FILE']}@{config_vars['SENTENCE_EMBEDDER_MODEL_DIR']}@"
    f"{config_vars['RERANKER_TRAIN_FINETUNE_DATA_FILE']}@{config_vars['RERANKER_FINETUNE_CONFIG_FILE']}@"
