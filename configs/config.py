...
DIR_PATH=os.getcwd() 
# Query Unit Knobs
QUNITS_FILE = '/saved_data/{0}/qunits.json'
QUNITS_DEBUG_FILE = '/saved_data/{0}/qunits_debug.json'
QUNITS_SET_COVER_FILE = '/saved_data/{0}/qunits_set_cover.json'
QUNITS_SET_COVER_MINUS_FILE = '/saved_data/{0}/qunits_set_generated_cover.json'
...
RERANKER_TRAIN_DATA_FILE = '/saved_data/{0}/reranker/train.json'
RERANKER_DEV_DATA_FILE = '/saved_data/{0}/reranker/dev.json'
RERANKER_CONFIG_FILE = '/ranker/BERTPooler/train_configs/ranker_pair.jsonnet'
RERANKER_MODEL_DIR= '/saved_data/{0}/reranker'
# Serialization knobs
GENERATION_NUM=20000
SERIALIZE_DATA_DIR = '/saved_data/{0}/serialization'
# Output knobs
