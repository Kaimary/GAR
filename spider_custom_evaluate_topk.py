...
from config import RERANKER_MISS_TOPK_FILE_NAME, PRED_SQL_TOPK_FILE_NAME
...
def main(tables_file, db_dir, reranker_model_output_file, reranker_test_data_file, experiment_dir_name):
    ...
    with open(experiment_dir_name + '/' + RERANKER_MISS_TOPK_FILE_NAME, 'w') as f:
    ...
    with open(experiment_dir_name + '/' + PRED_SQL_TOPK_FILE_NAME, 'w') as f:
