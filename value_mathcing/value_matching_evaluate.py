...
from config import TEST_DATA_FILE_NAME, VALUE_FILTERED_TOPK_FILE_NAME
...
def main(tables_file, db_dir, value_filtered_output_file, experiment_dir_name):
    pred_count = 0
    preds = []
    ...
    reranker_test_data_file = os.path.join(experiment_dir_name, TEST_DATA_FILE_NAME)
