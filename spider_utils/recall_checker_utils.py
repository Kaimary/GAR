...
from spider_utils.evaluation.evaluate import Evaluator, rebuild_sql
...
class RecallChecker():
    def __init__(self, dataset_file, tables_file, db_dir, kmaps):
    ...
    def check_add_candidategen_miss_sql(self, db_id, sqls, gold_sql, db_dir, kmaps):
        evaluator = Evaluator()
    ...
    def export_candidategen_miss_sqls(self):
        candidategen_miss_sqls_file = "./candidategen_miss_sqls.json"
        with open(candidategen_miss_sqls_file, 'w') as f:
